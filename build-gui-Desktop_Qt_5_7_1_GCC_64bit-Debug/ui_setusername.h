...
public:
    ...
    {
        SetUsername->setWindowTitle(QApplication::translate("SetUsername", "SetName", Q_NULLPTR));
        cancelsetname->setText(QApplication::translate("SetUsername", "cancel", Q_NULLPTR));
        oksetname->setText(QApplication::translate("SetUsername", "ok", Q_NULLPTR));
    } // retranslateUi
