...
public:
    ...
    {
        ChatWnd->setWindowTitle(QApplication::translate("ChatWnd", "Form", Q_NULLPTR));
        send->setText(QApplication::translate("ChatWnd", "send", Q_NULLPTR));
        send_file->setText(QApplication::translate("ChatWnd", "send file", Q_NULLPTR));
    } // retranslateUi
